 ...
 */var mm;function iE(){if(mm)return Ae;mm=1;var i=Symbol.for("react.element"),e=Symbol.for("react.portal"),t=Symbol.for("react.fragment"),s=Symbol.for("react.strict_mode"),o=Symbol.for("react.profiler"),u=Symbol.for("react.provider"),h=Symbol.for("react.context"),m=Symbol.for("react.forward_ref"),g=Symbol.for("react.suspense"),v=Symbol.for("react.memo"),T=Symbol.for("react.lazy"),N=Symbol.iterator;function b(x){return x===null||typeof x!="object"?null:(x=N&&x[N]||x["@@iterator"],typeof x=="function"?x:null)}var j={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Q=Object.assign,Y={};function q(x,z,le){this.props=x,this.context=z,this.refs=Y,this.updater=le||j}q.prototype.isReactComponent={},q.prototype.setState=function(x,z){if(typeof x!="object"&&typeof x!="function"&&x!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,x,z,"setState")},q.prototype.forceUpdate=function(x){this.updater.enqueueForceUpdate(this,x,"forceUpdate")};function Ee(){}Ee.prototype=q.prototype;function ge(x,z,le){this.props=x,this.context=z,this.refs=Y,this.updater=le||j}var ye=ge.prototype=new Ee;ye.constructor=ge,Q(ye,q.prototype),ye.isPureReactComponent=!0;var we=Array.isArray,ze=Object.prototype.hasOwnProperty,Te={current:null},k={key:!0,ref:!0,__self:!0,__source:!0};function w(x,z,le){var Ie,Se={},ke=null,Le=null;if(z!=null)for(Ie in z.ref!==void 0&&(Le=z.ref),z.key!==void 0&&(ke=""+z.key),z)ze.call(z,Ie)&&!k.hasOwnProperty(Ie)&&(Se[Ie]=z[Ie]);var Me=arguments.length-2;if(Me===1)Se.children=le;else if(1<Me){for(var Be=Array(Me),pt=0;pt<Me;pt++)Be[pt]=arguments[pt+2];Se.children=Be}if(x&&x.defaultProps)for(Ie in Me=x.defaultProps,Me)Se[Ie]===void 0&&(Se[Ie]=Me[Ie]);return{$$typeof:i,type:x,key:ke,ref:Le,props:Se,_owner:Te.current}}function S(x,z){return{$$typeof:i,type:x.type,key:z,ref:x.ref,props:x.props,_owner:x._owner}}function P(x){return typeof x=="object"&&x!==null&&x.$$typeof===i}function D(x){var z={"=":"=0",":":"=2"};return"$"+x.replace(/[=:]/g,function(le){return z[le]})}var V=/\/+/g;function A(x,z){return typeof x=="object"&&x!==null&&x.key!=null?D(""+x.key):z.toString(36)}function et(x,z,le,Ie,Se){var ke=typeof x;(ke==="undefined"||ke==="boolean")&&(x=null);var Le=!1;if(x===null)Le=!0;else switch(ke){case"string":case"number":Le=!0;break;case"object":switch(x.$$typeof){case i:case e:Le=!0}}if(Le)return Le=x,Se=Se(Le),x=Ie===""?"."+A(Le,0):Ie,we(Se)?(le="",x!=null&&(le=x.replace(V,"$&/")+"/"),et(Se,z,le,"",function(pt){return pt})):Se!=null&&(P(Se)&&(Se=S(Se,le+(!Se.key||Le&&Le.key===Se.key?"":(""+Se.key).replace(V,"$&/")+"/")+x)),z.push(Se)),1;if(Le=0,Ie=Ie===""?".":Ie+":",we(x))for(var Me=0;Me<x.length;Me++){ke=x[Me];var Be=Ie+A(ke,Me);Le+=et(ke,z,le,Be,Se)}else if(Be=b(x),typeof Be=="function")for(x=Be.call(x),Me=0;!(ke=x.next()).done;)ke=ke.value,Be=Ie+A(ke,Me++),Le+=et(ke,z,le,Be,Se);else if(ke==="object")throw z=String(x),Error("Objects are not valid as a React child (found: "+(z==="[object Object]"?"object with keys {"+Object.keys(x).join(", ")+"}":z)+"). If you meant to render a collection of children, use an array instead.");return Le}function Ct(x,z,le){if(x==null)return x;var Ie=[],Se=0;return et(x,Ie,"","",function(ke){return z.call(le,ke,Se++)}),Ie}function kt(x){if(x._status===-1){var z=x._result;z=z(),z.then(function(le){(x._status===0||x._status===-1)&&(x._status=1,x._result=le)},function(le){(x._status===0||x._status===-1)&&(x._status=2,x._result=le)}),x._status===-1&&(x._status=0,x._result=z)}if(x._status===1)return x._result.default;throw x._result}var Ue={current:null},J={transition:null},ce={ReactCurrentDispatcher:Ue,ReactCurrentBatchConfig:J,ReactCurrentOwner:Te};function te(){throw Error("act(...) is not supported in production builds of React.")}return Ae.Children={map:Ct,forEach:function(x,z,le){Ct(x,function(){z.apply(this,arguments)},le)},count:function(x){var z=0;return Ct(x,function(){z++}),z},toArray:function(x){return Ct(x,function(z){return z})||[]},only:function(x){if(!P(x))throw Error("React.Children.only expected to receive a single React element child.");return x}},Ae.Component=q,Ae.Fragment=t,Ae.Profiler=o,Ae.PureComponent=ge,Ae.StrictMode=s,Ae.Suspense=g,Ae.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=ce,Ae.act=te,Ae.cloneElement=function(x,z,le){if(x==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+x+".");var Ie=Q({},x.props),Se=x.key,ke=x.ref,Le=x._owner;if(z!=null){if(z.ref!==void 0&&(ke=z.ref,Le=Te.current),z.key!==void 0&&(Se=""+z.key),x.type&&x.type.defaultProps)var Me=x.type.defaultProps;for(Be in z)ze.call(z,Be)&&!k.hasOwnProperty(Be)&&(Ie[Be]=z[Be]===void 0&&Me!==void 0?Me[Be]:z[Be])}var Be=arguments.length-2;if(Be===1)Ie.children=le;else if(1<Be){Me=Array(Be);for(var pt=0;pt<Be;pt++)Me[pt]=arguments[pt+2];Ie.children=Me}return{$$typeof:i,type:x.type,key:Se,ref:ke,props:Ie,_owner:Le}},Ae.createContext=function(x){return x={$$typeof:h,_currentValue:x,_currentValue2:x,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},x.Provider={$$typeof:u,_context:x},x.Consumer=x},Ae.createElement=w,Ae.createFactory=function(x){var z=w.bind(null,x);return z.type=x,z},Ae.createRef=function(){return{current:null}},Ae.forwardRef=function(x){return{$$typeof:m,render:x}},Ae.isValidElement=P,Ae.lazy=function(x){return{$$typeof:T,_payload:{_status:-1,_result:x},_init:kt}},Ae.memo=function(x,z){return{$$typeof:v,type:x,compare:z===void 0?null:z}},Ae.startTransition=function(x){var z=J.transition;J.transition={};try{x()}finally{J.transition=z}},Ae.unstable_act=te,Ae.useCallback=function(x,z){return Ue.current.useCallback(x,z)},Ae.useContext=function(x){return Ue.current.useContext(x)},Ae.useDebugValue=function(){},Ae.useDeferredValue=function(x){return Ue.current.useDeferredValue(x)},Ae.useEffect=function(x,z){return Ue.current.useEffect(x,z)},Ae.useId=function(){return Ue.current.useId()},Ae.useImperativeHandle=function(x,z,le){return Ue.current.useImperativeHandle(x,z,le)},Ae.useInsertionEffect=function(x,z){return Ue.current.useInsertionEffect(x,z)},Ae.useLayoutEffect=function(x,z){return Ue.current.useLayoutEffect(x,z)},Ae.useMemo=function(x,z){return Ue.current.useMemo(x,z)},Ae.useReducer=function(x,z,le){return Ue.current.useReducer(x,z,le)},Ae.useRef=function(x){return Ue.current.useRef(x)},Ae.useState=function(x){return Ue.current.useState(x)},Ae.useSyncExternalStore=function(x,z,le){return Ue.current.useSyncExternalStore(x,z,le)},Ae.useTransition=function(){return Ue.current.useTransition()},Ae.version="18.3.1",Ae}var gm;function gd(){return gm||(gm=1,Dh.exports=iE()),Dh.exports}/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var vm;function lE(){return vm||(vm=1,(function(i){function e(J,ce){var te=J.length;J.push(ce);e:for(;0<te;){var x=te-1>>>1,z=J[x];if(0<o(z,ce))J[x]=ce,J[te]=z,te=x;else break e}}function t(J){return J.length===0?null:J[0]}function s(J){if(J.length===0)return null;var ce=J[0],te=J.pop();if(te!==ce){J[0]=te;e:for(var x=0,z=J.length,le=z>>>1;x<le;){var Ie=2*(x+1)-1,Se=J[Ie],ke=Ie+1,Le=J[ke];if(0>o(Se,te))ke<z&&0>o(Le,Se)?(J[x]=Le,J[ke]=te,x=ke):(J[x]=Se,J[Ie]=te,x=Ie);else if(ke<z&&0>o(Le,te))J[x]=Le,J[ke]=te,x=ke;else break e}}return ce}function o(J,ce){var te=J.sortIndex-ce.sortIndex;return te!==0?te:J.id-ce.id}if(typeof performance=="object"&&typeof performance.now=="function"){var u=performance;i.unstable_now=function(){return u.now()}}else{var h=Date,m=h.now();i.unstable_now=function(){return h.now()-m}}var g=[],v=[],T=1,N=null,b=3,j=!1,Q=!1,Y=!1,q=typeof setTimeout=="function"?setTimeout:null,Ee=typeof clearTimeout=="function"?clearTimeout:null,ge=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function ye(J){for(var ce=t(v);ce!==null;){if(ce.callback===null)s(v);else if(ce.startTime<=J)s(v),ce.sortIndex=ce.expirationTime,e(g,ce);else break;ce=t(v)}}function we(J){if(Y=!1,ye(J),!Q)if(t(g)!==null)Q=!0,kt(ze);else{var ce=t(v);ce!==null&&Ue(we,ce.startTime-J)}}function ze(J,ce){Q=!1,Y&&(Y=!1,Ee(w),w=-1),j=!0;var te=b;try{for(ye(ce),N=t(g);N!==null&&(!(N.expirationTime>ce)||J&&!D());){var x=N.callback;if(typeof x=="function"){N.callback=null,b=N.priorityLevel;var z=x(N.expirationTime<=ce);ce=i.unstable_now(),typeof z=="function"?N.callback=z:N===t(g)&&s(g),ye(ce)}else s(g);N=t(g)}if(N!==null)var le=!0;else{var Ie=t(v);Ie!==null&&Ue(we,Ie.startTime-ce),le=!1}return le}finally{N=null,b=te,j=!1}}var Te=!1,k=null,w=-1,S=5,P=-1;function D(){return!(i.unstable_now()-P<S)}function V(){if(k!==null){var J=i.unstable_now();P=J;var ce=!0;try{ce=k(!0,J)}finally{ce?A():(Te=!1,k=null)}}else Te=!1}var A;if(typeof ge=="function")A=function(){ge(V)};else if(typeof MessageChannel<"u"){var et=new MessageChannel,Ct=et.port2;et.port1.onmessage=V,A=function(){Ct.postMessage(null)}}else A=function(){q(V,0)};function kt(J){k=J,Te||(Te=!0,A())}function Ue(J,ce){w=q(function(){J(i.unstable_now())},ce)}i.unstable_IdlePriority=5,i.unstable_ImmediatePriority=1,i.unstable_LowPriority=4,i.unstable_NormalPriority=3,i.unstable_Profiling=null,i.unstable_UserBlockingPriority=2,i.unstable_cancelCallback=function(J){J.callback=null},i.unstable_continueExecution=function(){Q||j||(Q=!0,kt(ze))},i.unstable_forceFrameRate=function(J){0>J||125<J?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):S=0<J?Math.floor(1e3/J):5},i.unstable_getCurrentPriorityLevel=function(){return b},i.unstable_getFirstCallbackNode=function(){return t(g)},i.unstable_next=function(J){switch(b){case 1:case 2:case 3:var ce=3;break;default:ce=b}var te=b;b=ce;try{return J()}finally{b=te}},i.unstable_pauseExecution=function(){},i.unstable_requestPaint=function(){},i.unstable_runWithPriority=function(J,ce){switch(J){case 1:case 2:case 3:case 4:case 5:break;default:J=3}var te=b;b=J;try{return ce()}finally{b=te}},i.unstable_scheduleCallback=function(J,ce,te){var x=i.unstable_now();switch(typeof te=="object"&&te!==null?(te=te.delay,te=typeof te=="number"&&0<te?x+te:x):te=x,J){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=te+z,J={id:T++,callback:ce,priorityLevel:J,startTime:te,expirationTime:z,sortIndex:-1},te>x?(J.sortIndex=te,e(v,J),t(g)===null&&J===t(v)&&(Y?(Ee(w),w=-1):Y=!0,Ue(we,te-x))):(J.sortIndex=z,e(g,J),Q||j||(Q=!0,kt(ze))),J},i.unstable_shouldYield=D,i.unstable_wrapCallback=function(J){var ce=b;return function(){var te=b;b=ce;try{return J.apply(this,arguments)}finally{b=te}}}})(Oh)),Oh}var Em;function uE(){return Em||(Em=1,Vh.exports=lE()),Vh.exports}/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bt(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function AE(){return typeof window<"u"&&!!(window.cordova||window.phonegap||window.PhoneGap)&&/ios|iphone|ipod|ipad|android|blackberry|iemobile/i.test(bt())}function RE(){var i;const e=(i=Bu())===null||i===void 0?void 0:i.forceEnvironment;if(e==="node")return!0;if(e==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function PE(){return typeof navigator<"u"&&navigator.userAgent==="Cloudflare-Workers"}function CE(){const i=typeof chrome=="object"?chrome.runtime:typeof browser=="object"?browser.runtime:void 0;return typeof i=="object"&&i.id!==void 0}function kE(){return typeof navigator=="object"&&navigator.product==="ReactNative"}function NE(){const i=bt();return i.indexOf("MSIE ")>=0||i.indexOf("Trident/")>=0}function DE(){return!RE()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function xE(){try{return typeof indexedDB=="object"}catch{return!1}}function VE(){return new Promise((i,e)=>{try{let t=!0;const s="validate-browser-context-for-indexeddb-analytics-module",o=self.indexedDB.open(s);o.onsuccess=()=>{o.result.close(),t||self.indexedDB.deleteDatabase(s),i(!0)},o.onupgradeneeded=()=>{t=!1},o.onerror=()=>{var u;e(((u=o.error)===null||u===void 0?void 0:u.message)||"")}}catch(t){e(t)}})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
*/var qi,ny;(function(){var i;/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/function e(k,w){function S(){}S.prototype=w.prototype,k.D=w.prototype,k.prototype=new S,k.prototype.constructor=k,k.C=function(P,D,V){for(var A=Array(arguments.length-2),et=2;et<arguments.length;et++)A[et-2]=arguments[et];return w.prototype[D].apply(P,A)}}function t(){this.blockSize=-1}function s(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}e(s,t),s.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function o(k,w,S){S||(S=0);var P=Array(16);if(typeof w=="string")for(var D=0;16>D;++D)P[D]=w.charCodeAt(S++)|w.charCodeAt(S++)<<8|w.charCodeAt(S++)<<16|w.charCodeAt(S++)<<24;else for(D=0;16>D;++D)P[D]=w[S++]|w[S++]<<8|w[S++]<<16|w[S++]<<24;w=k.g[0],S=k.g[1],D=k.g[2];var V=k.g[3],A=w+(V^S&(D^V))+P[0]+3614090360&4294967295;w=S+(A<<7&4294967295|A>>>25),A=V+(D^w&(S^D))+P[1]+3905402710&4294967295,V=w+(A<<12&4294967295|A>>>20),A=D+(S^V&(w^S))+P[2]+606105819&4294967295,D=V+(A<<17&4294967295|A>>>15),A=S+(w^D&(V^w))+P[3]+3250441966&4294967295,S=D+(A<<22&4294967295|A>>>10),A=w+(V^S&(D^V))+P[4]+4118548399&4294967295,w=S+(A<<7&4294967295|A>>>25),A=V+(D^w&(S^D))+P[5]+1200080426&4294967295,V=w+(A<<12&4294967295|A>>>20),A=D+(S^V&(w^S))+P[6]+2821735955&4294967295,D=V+(A<<17&4294967295|A>>>15),A=S+(w^D&(V^w))+P[7]+4249261313&4294967295,S=D+(A<<22&4294967295|A>>>10),A=w+(V^S&(D^V))+P[8]+1770035416&4294967295,w=S+(A<<7&4294967295|A>>>25),A=V+(D^w&(S^D))+P[9]+2336552879&4294967295,V=w+(A<<12&4294967295|A>>>20),A=D+(S^V&(w^S))+P[10]+4294925233&4294967295,D=V+(A<<17&4294967295|A>>>15),A=S+(w^D&(V^w))+P[11]+2304563134&4294967295,S=D+(A<<22&4294967295|A>>>10),A=w+(V^S&(D^V))+P[12]+1804603682&4294967295,w=S+(A<<7&4294967295|A>>>25),A=V+(D^w&(S^D))+P[13]+4254626195&4294967295,V=w+(A<<12&4294967295|A>>>20),A=D+(S^V&(w^S))+P[14]+2792965006&4294967295,D=V+(A<<17&4294967295|A>>>15),A=S+(w^D&(V^w))+P[15]+1236535329&4294967295,S=D+(A<<22&4294967295|A>>>10),A=w+(D^V&(S^D))+P[1]+4129170786&4294967295,w=S+(A<<5&4294967295|A>>>27),A=V+(S^D&(w^S))+P[6]+3225465664&4294967295,V=w+(A<<9&4294967295|A>>>23),A=D+(w^S&(V^w))+P[11]+643717713&4294967295,D=V+(A<<14&4294967295|A>>>18),A=S+(V^w&(D^V))+P[0]+3921069994&4294967295,S=D+(A<<20&4294967295|A>>>12),A=w+(D^V&(S^D))+P[5]+3593408605&4294967295,w=S+(A<<5&4294967295|A>>>27),A=V+(S^D&(w^S))+P[10]+38016083&4294967295,V=w+(A<<9&4294967295|A>>>23),A=D+(w^S&(V^w))+P[15]+3634488961&4294967295,D=V+(A<<14&4294967295|A>>>18),A=S+(V^w&(D^V))+P[4]+3889429448&4294967295,S=D+(A<<20&4294967295|A>>>12),A=w+(D^V&(S^D))+P[9]+568446438&4294967295,w=S+(A<<5&4294967295|A>>>27),A=V+(S^D&(w^S))+P[14]+3275163606&4294967295,V=w+(A<<9&4294967295|A>>>23),A=D+(w^S&(V^w))+P[3]+4107603335&4294967295,D=V+(A<<14&4294967295|A>>>18),A=S+(V^w&(D^V))+P[8]+1163531501&4294967295,S=D+(A<<20&4294967295|A>>>12),A=w+(D^V&(S^D))+P[13]+2850285829&4294967295,w=S+(A<<5&4294967295|A>>>27),A=V+(S^D&(w^S))+P[2]+4243563512&4294967295,V=w+(A<<9&4294967295|A>>>23),A=D+(w^S&(V^w))+P[7]+1735328473&4294967295,D=V+(A<<14&4294967295|A>>>18),A=S+(V^w&(D^V))+P[12]+2368359562&4294967295,S=D+(A<<20&4294967295|A>>>12),A=w+(S^D^V)+P[5]+4294588738&4294967295,w=S+(A<<4&4294967295|A>>>28),A=V+(w^S^D)+P[8]+2272392833&4294967295,V=w+(A<<11&4294967295|A>>>21),A=D+(V^w^S)+P[11]+1839030562&4294967295,D=V+(A<<16&4294967295|A>>>16),A=S+(D^V^w)+P[14]+4259657740&4294967295,S=D+(A<<23&4294967295|A>>>9),A=w+(S^D^V)+P[1]+2763975236&4294967295,w=S+(A<<4&4294967295|A>>>28),A=V+(w^S^D)+P[4]+1272893353&4294967295,V=w+(A<<11&4294967295|A>>>21),A=D+(V^w^S)+P[7]+4139469664&4294967295,D=V+(A<<16&4294967295|A>>>16),A=S+(D^V^w)+P[10]+3200236656&4294967295,S=D+(A<<23&4294967295|A>>>9),A=w+(S^D^V)+P[13]+681279174&4294967295,w=S+(A<<4&4294967295|A>>>28),A=V+(w^S^D)+P[0]+3936430074&4294967295,V=w+(A<<11&4294967295|A>>>21),A=D+(V^w^S)+P[3]+3572445317&4294967295,D=V+(A<<16&4294967295|A>>>16),A=S+(D^V^w)+P[6]+76029189&4294967295,S=D+(A<<23&4294967295|A>>>9),A=w+(S^D^V)+P[9]+3654602809&4294967295,w=S+(A<<4&4294967295|A>>>28),A=V+(w^S^D)+P[12]+3873151461&4294967295,V=w+(A<<11&4294967295|A>>>21),A=D+(V^w^S)+P[15]+530742520&4294967295,D=V+(A<<16&4294967295|A>>>16),A=S+(D^V^w)+P[2]+3299628645&4294967295,S=D+(A<<23&4294967295|A>>>9),A=w+(D^(S|~V))+P[0]+4096336452&4294967295,w=S+(A<<6&4294967295|A>>>26),A=V+(S^(w|~D))+P[7]+1126891415&4294967295,V=w+(A<<10&4294967295|A>>>22),A=D+(w^(V|~S))+P[14]+2878612391&4294967295,D=V+(A<<15&4294967295|A>>>17),A=S+(V^(D|~w))+P[5]+4237533241&4294967295,S=D+(A<<21&4294967295|A>>>11),A=w+(D^(S|~V))+P[12]+1700485571&4294967295,w=S+(A<<6&4294967295|A>>>26),A=V+(S^(w|~D))+P[3]+2399980690&4294967295,V=w+(A<<10&4294967295|A>>>22),A=D+(w^(V|~S))+P[10]+4293915773&4294967295,D=V+(A<<15&4294967295|A>>>17),A=S+(V^(D|~w))+P[1]+2240044497&4294967295,S=D+(A<<21&4294967295|A>>>11),A=w+(D^(S|~V))+P[8]+1873313359&4294967295,w=S+(A<<6&4294967295|A>>>26),A=V+(S^(w|~D))+P[15]+4264355552&4294967295,V=w+(A<<10&4294967295|A>>>22),A=D+(w^(V|~S))+P[6]+2734768916&4294967295,D=V+(A<<15&4294967295|A>>>17),A=S+(V^(D|~w))+P[13]+1309151649&4294967295,S=D+(A<<21&4294967295|A>>>11),A=w+(D^(S|~V))+P[4]+4149444226&4294967295,w=S+(A<<6&4294967295|A>>>26),A=V+(S^(w|~D))+P[11]+3174756917&4294967295,V=w+(A<<10&4294967295|A>>>22),A=D+(w^(V|~S))+P[2]+718787259&4294967295,D=V+(A<<15&4294967295|A>>>17),A=S+(V^(D|~w))+P[9]+3951481745&4294967295,k.g[0]=k.g[0]+w&4294967295,k.g[1]=k.g[1]+(D+(A<<21&4294967295|A>>>11))&4294967295,k.g[2]=k.g[2]+D&4294967295,k.g[3]=k.g[3]+V&4294967295}s.prototype.u=function(k,w){w===void 0&&(w=k.length);for(var S=w-this.blockSize,P=this.B,D=this.h,V=0;V<w;){if(D==0)for(;V<=S;)o(this,k,V),V+=this.blockSize;if(typeof k=="string"){for(;V<w;)if(P[D++]=k.charCodeAt(V++),D==this.blockSize){o(this,P),D=0;break}}else for(;V<w;)if(P[D++]=k[V++],D==this.blockSize){o(this,P),D=0;break}}this.h=D,this.o+=w},s.prototype.v=function(){var k=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);k[0]=128;for(var w=1;w<k.length-8;++w)k[w]=0;var S=8*this.o;for(w=k.length-8;w<k.length;++w)k[w]=S&255,S/=256;for(this.u(k),k=Array(16),w=S=0;4>w;++w)for(var P=0;32>P;P+=8)k[S++]=this.g[w]>>>P&255;return k};function u(k,w){var S=m;return Object.prototype.hasOwnProperty.call(S,k)?S[k]:S[k]=w(k)}function h(k,w){this.h=w;for(var S=[],P=!0,D=k.length-1;0<=D;D--){var V=k[D]|0;P&&V==w||(S[D]=V,P=!1)}this.g=S}var m={};function g(k){return-128<=k&&128>k?u(k,function(w){return new h([w|0],0>w?-1:0)}):new h([k|0],0>k?-1:0)}function v(k){if(isNaN(k)||!isFinite(k))return N;if(0>k)return q(v(-k));for(var w=[],S=1,P=0;k>=S;P++)w[P]=k/S|0,S*=4294967296;return new h(w,0)}function T(k,w){if(k.length==0)throw Error("number format error: empty string");if(w=w||10,2>w||36<w)throw Error("radix out of range: "+w);if(k.charAt(0)=="-")return q(T(k.substring(1),w));if(0<=k.indexOf("-"))throw Error('number format error: interior "-" character');for(var S=v(Math.pow(w,8)),P=N,D=0;D<k.length;D+=8){var V=Math.min(8,k.length-D),A=parseInt(k.substring(D,D+V),w);8>V?(V=v(Math.pow(w,V)),P=P.j(V).add(v(A))):(P=P.j(S),P=P.add(v(A)))}return P}var N=g(0),b=g(1),j=g(16777216);i=h.prototype,i.m=function(){if(Y(this))return-q(this).m();for(var k=0,w=1,S=0;S<this.g.length;S++){var P=this.i(S);k+=(0<=P?P:4294967296+P)*w,w*=4294967296}return k},i.toString=function(k){if(k=k||10,2>k||36<k)throw Error("radix out of range: "+k);if(Q(this))return"0";if(Y(this))return"-"+q(this).toString(k);for(var w=v(Math.pow(k,6)),S=this,P="";;){var D=we(S,w).g;S=Ee(S,D.j(w));var V=((0<S.g.length?S.g[0]:S.h)>>>0).toString(k);if(S=D,Q(S))return V+P;for(;6>V.length;)V="0"+V;P=V+P}},i.i=function(k){return 0>k?0:k<this.g.length?this.g[k]:this.h};function Q(k){if(k.h!=0)return!1;for(var w=0;w<k.g.length;w++)if(k.g[w]!=0)return!1;return!0}function Y(k){return k.h==-1}i.l=function(k){return k=Ee(this,k),Y(k)?-1:Q(k)?0:1};function q(k){for(var w=k.g.length,S=[],P=0;P<w;P++)S[P]=~k.g[P];return new h(S,~k.h).add(b)}i.abs=function(){return Y(this)?q(this):this},i.add=function(k){for(var w=Math.max(this.g.length,k.g.length),S=[],P=0,D=0;D<=w;D++){var V=P+(this.i(D)&65535)+(k.i(D)&65535),A=(V>>>16)+(this.i(D)>>>16)+(k.i(D)>>>16);P=A>>>16,V&=65535,A&=65535,S[D]=A<<16|V}return new h(S,S[S.length-1]&-2147483648?-1:0)};function Ee(k,w){return k.add(q(w))}i.j=function(k){if(Q(this)||Q(k))return N;if(Y(this))return Y(k)?q(this).j(q(k)):q(q(this).j(k));if(Y(k))return q(this.j(q(k)));if(0>this.l(j)&&0>k.l(j))return v(this.m()*k.m());for(var w=this.g.length+k.g.length,S=[],P=0;P<2*w;P++)S[P]=0;for(P=0;P<this.g.length;P++)for(var D=0;D<k.g.length;D++){var V=this.i(P)>>>16,A=this.i(P)&65535,et=k.i(D)>>>16,Ct=k.i(D)&65535;S[2*P+2*D]+=A*Ct,ge(S,2*P+2*D),S[2*P+2*D+1]+=V*Ct,ge(S,2*P+2*D+1),S[2*P+2*D+1]+=A*et,ge(S,2*P+2*D+1),S[2*P+2*D+2]+=V*et,ge(S,2*P+2*D+2)}for(P=0;P<w;P++)S[P]=S[2*P+1]<<16|S[2*P];for(P=w;P<2*w;P++)S[P]=0;return new h(S,0)};function ge(k,w){for(;(k[w]&65535)!=k[w];)k[w+1]+=k[w]>>>16,k[w]&=65535,w++}function ye(k,w){this.g=k,this.h=w}function we(k,w){if(Q(w))throw Error("division by zero");if(Q(k))return new ye(N,N);if(Y(k))return w=we(q(k),w),new ye(q(w.g),q(w.h));if(Y(w))return w=we(k,q(w)),new ye(q(w.g),w.h);if(30<k.g.length){if(Y(k)||Y(w))throw Error("slowDivide_ only works with positive integers.");for(var S=b,P=w;0>=P.l(k);)S=ze(S),P=ze(P);var D=Te(S,1),V=Te(P,1);for(P=Te(P,2),S=Te(S,2);!Q(P);){var A=V.add(P);0>=A.l(k)&&(D=D.add(S),V=A),P=Te(P,1),S=Te(S,1)}return w=Ee(k,D.j(w)),new ye(D,w)}for(D=N;0<=k.l(w);){for(S=Math.max(1,Math.floor(k.m()/w.m())),P=Math.ceil(Math.log(S)/Math.LN2),P=48>=P?1:Math.pow(2,P-48),V=v(S),A=V.j(w);Y(A)||0<A.l(k);)S-=P,V=v(S),A=V.j(w);Q(V)&&(V=b),D=D.add(V),k=Ee(k,A)}return new ye(D,k)}i.A=function(k){return we(this,k).h},i.and=function(k){for(var w=Math.max(this.g.length,k.g.length),S=[],P=0;P<w;P++)S[P]=this.i(P)&k.i(P);return new h(S,this.h&k.h)},i.or=function(k){for(var w=Math.max(this.g.length,k.g.length),S=[],P=0;P<w;P++)S[P]=this.i(P)|k.i(P);return new h(S,this.h|k.h)},i.xor=function(k){for(var w=Math.max(this.g.length,k.g.length),S=[],P=0;P<w;P++)S[P]=this.i(P)^k.i(P);return new h(S,this.h^k.h)};function ze(k){for(var w=k.g.length+1,S=[],P=0;P<w;P++)S[P]=k.i(P)<<1|k.i(P-1)>>>31;return new h(S,k.h)}function Te(k,w){var S=w>>5;w%=32;for(var P=k.g.length-S,D=[],V=0;V<P;V++)D[V]=0<w?k.i(V+S)>>>w|k.i(V+S+1)<<32-w:k.i(V+S);return new h(D,k.h)}s.prototype.digest=s.prototype.v,s.prototype.reset=s.prototype.s,s.prototype.update=s.prototype.u,ny=s,h.prototype.add=h.prototype.add,h.prototype.multiply=h.prototype.j,h.prototype.modulo=h.prototype.A,h.prototype.compare=h.prototype.l,h.prototype.toNumber=h.prototype.m,h.prototype.toString=h.prototype.toString,h.prototype.getBits=h.prototype.i,h.fromNumber=v,h.fromString=T,qi=h}).apply(typeof Om<"u"?Om:typeof self<"u"?self:typeof window<"u"?window:{});var uu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
Copyright The Closure Library Authors.
SPDX-License-Identifier: Apache-2.0
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ma(i){if(i.code!==B.FAILED_PRECONDITION||i.message!==l0)throw i;oe("LocalStore","Unexpectedly lost primary lease")}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const N0=new Je(ue.comparator);function Sr(){return N0}const Iy=new Je(ue.comparator);function ya(...i){let e=Iy;for(const t of i)e=e.insert(t.key,t);return e}function Sy(i){let e=Iy;return i.forEach(((t,s)=>e=e.insert(t,s.overlayedDocument))),e}function $i(){return wa()}function Ay(){return wa()}function wa(){return new ho((i=>i.toString()),((i,e)=>i.isEqual(e)))}const D0=new Je(ue.comparator),x0=new Rt(ue.comparator);function Re(...i){let e=x0;for(const t of i)e=e.add(t);return e}const V0=new Rt(Oe);function O0(){return V0}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Hu{constructor(){this._=void 0}}function M0(i,e,t){return i instanceof ka?(function(o,u){const h={fields:{__type__:{stringValue:"server_timestamp"},__local_write_time__:{timestampValue:{seconds:o.seconds,nanos:o.nanoseconds}}}};return u&&Td(u)&&(u=Id(u)),u&&(h.fields.__previous_value__=u),{mapValue:h}})(t,e):i instanceof Na?Cy(i,e):i instanceof Da?ky(i,e):(function(o,u){const h=Py(o,u),m=Km(h)+Km(o.Pe);return Zh(h)&&Zh(o.Pe)?Ry(m):Pd(o.serializer,m)})(i,e)}function b0(i,e,t){return i instanceof Na?Cy(i,e):i instanceof Da?ky(i,e):t}function Py(i,e){return i instanceof Du?(function(s){return Zh(s)||(function(u){return!!u&&"doubleValue"in u})(s)})(e)?e:{integerValue:0}:null}class ka extends Hu{}class Na extends Hu{constructor(e){super(),this.elements=e}}function Cy(i,e){const t=Ny(e);for(const s of i.elements)t.some((o=>Jn(o,s)))||t.push(s);return{arrayValue:{values:t}}}class Da extends Hu{constructor(e){super(),this.elements=e}}function ky(i,e){let t=Ny(e);for(const s of i.elements)t=t.filter((o=>!Jn(o,s)));return{arrayValue:{values:t}}}class Du extends Hu{constructor(e,t){super(),this.serializer=e,this.Pe=t}}function Km(i){return rt(i.integerValue||i.doubleValue)}function Ny(i){return Sd(i)&&i.arrayValue.values?i.arrayValue.values.slice():[]}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F0{constructor(e,t){this.field=e,this.transform=t}}function U0(i,e){return i.field.isEqual(e.field)&&(function(s,o){return s instanceof Na&&o instanceof Na||s instanceof Da&&o instanceof Da?no(s.elements,o.elements,Jn):s instanceof Du&&o instanceof Du?Jn(s.Pe,o.Pe):s instanceof ka&&o instanceof ka})(i.transform,e.transform)}class j0{constructor(e,t){this.version=e,this.transformResults=t}}class Er{constructor(e,t){this.updateTime=e,this.exists=t}static none(){return new Er}static exists(e){return new Er(void 0,e)}static updateTime(e){return new Er(e)}get isNone(){return this.updateTime===void 0&&this.exists===void 0}isEqual(e){return this.exists===e.exists&&(this.updateTime?!!e.updateTime&&this.updateTime.isEqual(e.updateTime):!e.updateTime)}}function _u(i,e){return i.updateTime!==void 0?e.isFoundDocument()&&e.version.isEqual(i.updateTime):i.exists===void 0||i.exists===e.isFoundDocument()}class Ku{}function Dy(i,e){if(!i.hasLocalMutations||e&&e.fields.length===0)return null;if(e===null)return i.isNoDocument()?new Vy(i.key,Er.none()):new Ua(i.key,i.data,Er.none());{const t=i.data,s=gn.empty();let o=new Rt(At.comparator);for(let u of e.fields)if(!o.has(u)){let h=t.field(u);h===null&&u.length>1&&(u=u.popLast(),h=t.field(u)),h===null?s.delete(u):s.set(u,h),o=o.add(u)}return new Xi(i.key,s,new Vn(o.toArray()),Er.none())}}function z0(i,e,t){i instanceof Ua?(function(o,u,h){const m=o.value.clone(),g=Qm(o.fieldTransforms,u,h.transformResults);m.setAll(g),u.convertToFoundDocument(h.version,m).setHasCommittedMutations()})(i,e,t):i instanceof Xi?(function(o,u,h){if(!_u(o.precondition,u))return void u.convertToUnknownDocument(h.version);const m=Qm(o.fieldTransforms,u,h.transformResults),g=u.data;g.setAll(xy(o)),g.setAll(m),u.convertToFoundDocument(h.version,g).setHasCommittedMutations()})(i,e,t):(function(o,u,h){u.convertToNoDocument(h.version).setHasCommittedMutations()})(0,e,t)}function Ta(i,e,t,s){return i instanceof Ua?(function(u,h,m,g){if(!_u(u.precondition,h))return m;const v=u.value.clone(),T=Ym(u.fieldTransforms,g,h);return v.setAll(T),h.convertToFoundDocument(h.version,v).setHasLocalMutations(),null})(i,e,t,s):i instanceof Xi?(function(u,h,m,g){if(!_u(u.precondition,h))return m;const v=Ym(u.fieldTransforms,g,h),T=h.data;return T.setAll(xy(u)),T.setAll(v),h.convertToFoundDocument(h.version,T).setHasLocalMutations(),m===null?null:m.unionWith(u.fieldMask.fields).unionWith(u.fieldTransforms.map((N=>N.field)))})(i,e,t,s):(function(u,h,m){return _u(u.precondition,h)?(h.convertToNoDocument(h.version).setHasLocalMutations(),null):m})(i,e,t)}function B0(i,e){let t=null;for(const s of i.fieldTransforms){const o=e.data.field(s.field),u=Py(s.transform,o||null);u!=null&&(t===null&&(t=gn.empty()),t.set(s.field,u))}return t||null}function Gm(i,e){return i.type===e.type&&!!i.key.isEqual(e.key)&&!!i.precondition.isEqual(e.precondition)&&!!(function(s,o){return s===void 0&&o===void 0||!(!s||!o)&&no(s,o,((u,h)=>U0(u,h)))})(i.fieldTransforms,e.fieldTransforms)&&(i.type===0?i.value.isEqual(e.value):i.type!==1||i.data.isEqual(e.data)&&i.fieldMask.isEqual(e.fieldMask))}class Ua extends Ku{constructor(e,t,s,o=[]){super(),this.key=e,this.value=t,this.precondition=s,this.fieldTransforms=o,this.type=0}getFieldMask(){return null}}class Xi extends Ku{constructor(e,t,s,o,u=[]){super(),this.key=e,this.data=t,this.fieldMask=s,this.precondition=o,this.fieldTransforms=u,this.type=1}getFieldMask(){return this.fieldMask}}function xy(i){const e=new Map;return i.fieldMask.fields.forEach((t=>{if(!t.isEmpty()){const s=i.data.field(t);e.set(t,s)}})),e}function Qm(i,e,t){const s=new Map;Fe(i.length===t.length);for(let o=0;o<t.length;o++){const u=i[o],h=u.transform,m=e.data.field(u.field);s.set(u.field,b0(h,m,t[o]))}return s}function Ym(i,e,t){const s=new Map;for(const o of i){const u=o.transform,h=t.data.field(o.field);s.set(o.field,M0(u,h,e))}return s}class Vy extends Ku{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2,this.fieldTransforms=[]}getFieldMask(){return null}}class $0 extends Ku{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _T{constructor(){this.changes=new ho((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,Mt.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const s=this.changes.get(t);return s!==void 0?H.resolve(s):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class wT{constructor(e){this.serializer=e,this.hr=new Map,this.Pr=new Map}getBundleMetadata(e,t){return H.resolve(this.hr.get(t))}saveBundleMetadata(e,t){return this.hr.set(t.id,(function(o){return{id:o.id,version:o.version,createTime:Qn(o.createTime)}})(t)),H.resolve()}getNamedQuery(e,t){return H.resolve(this.Pr.get(t))}saveNamedQuery(e,t){return this.Pr.set(t.name,(function(o){return{name:o.name,query:mT(o.bundledQuery),readTime:Qn(o.readTime)}})(t)),H.resolve()}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class TT{constructor(){this.overlays=new Je(ue.comparator),this.Ir=new Map}getOverlay(e,t){return H.resolve(this.overlays.get(t))}getOverlays(e,t){const s=$i();return H.forEach(t,(o=>this.getOverlay(e,o).next((u=>{u!==null&&s.set(o,u)})))).next((()=>s))}saveOverlays(e,t,s){return s.forEach(((o,u)=>{this.ht(e,t,u)})),H.resolve()}removeOverlaysForBatchId(e,t,s){const o=this.Ir.get(s);return o!==void 0&&(o.forEach((u=>this.overlays=this.overlays.remove(u))),this.Ir.delete(s)),H.resolve()}getOverlaysForCollection(e,t,s){const o=$i(),u=t.length+1,h=new ue(t.child("")),m=this.overlays.getIteratorFrom(h);for(;m.hasNext();){const g=m.getNext().value,v=g.getKey();if(!t.isPrefixOf(v.path))break;v.path.length===u&&g.largestBatchId>s&&o.set(g.getKey(),g)}return H.resolve(o)}getOverlaysForCollectionGroup(e,t,s,o){let u=new Je(((v,T)=>v-T));const h=this.overlays.getIterator();for(;h.hasNext();){const v=h.getNext().value;if(v.getKey().getCollectionGroup()===t&&v.largestBatchId>s){let T=u.get(v.largestBatchId);T===null&&(T=$i(),u=u.insert(v.largestBatchId,T)),T.set(v.getKey(),v)}}const m=$i(),g=u.getIterator();for(;g.hasNext()&&(g.getNext().value.forEach(((v,T)=>m.set(v,T))),!(m.size()>=o)););return H.resolve(m)}ht(e,t,s){const o=this.overlays.get(s.key);if(o!==null){const h=this.Ir.get(o.largestBatchId).delete(s.key);this.Ir.set(o.largestBatchId,h)}this.overlays=this.overlays.insert(s.key,new W0(t,s));let u=this.Ir.get(t);u===void 0&&(u=Re(),this.Ir.set(t,u)),this.Ir.set(t,u.add(s.key))}}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class IT{constructor(){this.sessionToken=Pt.EMPTY_BYTE_STRING}getSessionToken(e){return H.resolve(this.sessionToken)}setSessionToken(e,t){return this.sessionToken=t,H.resolve()}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DT{constructor(){this.Gi=!1,this.zi=!1,this.ji=100,this.Hi=(function(){return DE()?8:c0(bt())>0?6:4})()}initialize(e,t){this.Ji=e,this.indexManager=t,this.Gi=!0}getDocumentsMatchingQuery(e,t,s,o){const u={result:null};return this.Yi(e,t).next((h=>{u.result=h})).next((()=>{if(!u.result)return this.Zi(e,t,o,s).next((h=>{u.result=h}))})).next((()=>{if(u.result)return;const h=new NT;return this.Xi(e,t,h).next((m=>{if(u.result=m,this.zi)return this.es(e,t,h,m.size)}))})).next((()=>u.result))}es(e,t,s,o){return s.documentReadCount<this.ji?(ha()<=Ce.DEBUG&&oe("QueryEngine","SDK will not create cache indexes for query:",Hs(t),"since it only creates cache indexes for collection contains","more than or equal to",this.ji,"documents"),H.resolve()):(ha()<=Ce.DEBUG&&oe("QueryEngine","Query:",Hs(t),"scans",s.documentReadCount,"local documents and returns",o,"documents as results."),s.documentReadCount>this.Hi*o?(ha()<=Ce.DEBUG&&oe("QueryEngine","The SDK decides to create cache indexes for query:",Hs(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Gn(t))):H.resolve())}Yi(e,t){if(Hm(t))return H.resolve(null);let s=Gn(t);return this.indexManager.getIndexType(e,s).next((o=>o===0?null:(t.limit!==null&&o===1&&(t=rd(t,null,"F"),s=Gn(t)),this.indexManager.getDocumentsMatchingTarget(e,s).next((u=>{const h=Re(...u);return this.Ji.getDocuments(e,h).next((m=>this.indexManager.getMinOffset(e,s).next((g=>{const v=this.ts(t,m);return this.ns(t,v,h,g.readTime)?this.Yi(e,rd(t,null,"F")):this.rs(e,v,t,g)}))))})))))}Zi(e,t,s,o){return Hm(t)||o.isEqual(_e.min())?H.resolve(null):this.Ji.getDocuments(e,s).next((u=>{const h=this.ts(t,u);return this.ns(t,h,s,o)?H.resolve(null):(ha()<=Ce.DEBUG&&oe("QueryEngine","Re-using previous result from %s to execute query: %s",o.toString(),Hs(t)),this.rs(e,h,t,s0(o,-1)).next((m=>m)))}))}ts(e,t){let s=new Rt(Ty(e));return t.forEach(((o,u)=>{Wu(e,u)&&(s=s.add(u))})),s}ns(e,t,s,o){if(e.limit===null)return!1;if(s.size!==t.size)return!0;const u=e.limitType==="F"?t.last():t.first();return!!u&&(u.hasPendingWrites||u.version.compareTo(o)>0)}Xi(e,t,s){return ha()<=Ce.DEBUG&&oe("QueryEngine","Using full collection scan to execute query:",Hs(t)),this.Ji.getDocumentsMatchingQuery(e,t,ui.min(),s)}rs(e,t,s,o){return this.Ji.getDocumentsMatchingQuery(e,s,o).next((u=>(t.forEach((h=>{u=u.insert(h.key,h)})),u)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ot="WebChannelConnection";class qT extends class{constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const s=t.ssl?"https":"http",o=encodeURIComponent(this.databaseId.projectId),u=encodeURIComponent(this.databaseId.database);this.Do=s+"://"+t.host,this.vo=`projects/${o}/databases/${u}`,this.Co=this.databaseId.database==="(default)"?`project_id=${o}`:`project_id=${o}&database_id=${u}`}get Fo(){return!1}Mo(t,s,o,u,h){const m=zh(),g=this.xo(t,s.toUriEncodedString());oe("RestConnection",`Sending RPC '${t}' ${m}:`,g,o);const v={"google-cloud-resource-prefix":this.vo,"x-goog-request-params":this.Co};return this.Oo(v,u,h),this.No(t,g,v,o).then((T=>(oe("RestConnection",`Received RPC '${t}' ${m}: `,T),T)),(T=>{throw to("RestConnection",`RPC '${t}' ${m} failed with error: `,T,"url: ",g,"request:",o),T}))}Lo(t,s,o,u,h,m){return this.Mo(t,s,o,u,h)}Oo(t,s,o){t["X-Goog-Api-Client"]=(function(){return"gl-js/ fire/"+uo})(),t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),s&&s.headers.forEach(((u,h)=>t[h]=u)),o&&o.headers.forEach(((u,h)=>t[h]=u))}xo(t,s){const o=BT[t];return`${this.Do}/v1/${s}:${o}`}terminate(){}}{constructor(e){super(e),this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}No(e,t,s,o){const u=zh();return new Promise(((h,m)=>{const g=new ry;g.setWithCredentials(!0),g.listenOnce(iy.COMPLETE,(()=>{try{switch(g.getLastErrorCode()){case gu.NO_ERROR:const T=g.getResponseJson();oe(Ot,`XHR for RPC '${e}' ${u} received:`,JSON.stringify(T)),h(T);break;case gu.TIMEOUT:oe(Ot,`RPC '${e}' ${u} timed out`),m(new ie(B.DEADLINE_EXCEEDED,"Request time out"));break;case gu.HTTP_ERROR:const N=g.getStatus();if(oe(Ot,`RPC '${e}' ${u} failed with status:`,N,"response text:",g.getResponseText()),N>0){let b=g.getResponseJson();Array.isArray(b)&&(b=b[0]);const j=b==null?void 0:b.error;if(j&&j.status&&j.message){const Q=(function(q){const Ee=q.toLowerCase().replace(/_/g,"-");return Object.values(B).indexOf(Ee)>=0?Ee:B.UNKNOWN})(j.status);m(new ie(Q,j.message))}else m(new ie(B.UNKNOWN,"Server responded with status "+g.getStatus()))}else m(new ie(B.UNAVAILABLE,"Connection failed."));break;default:me()}}finally{oe(Ot,`RPC '${e}' ${u} completed.`)}}));const v=JSON.stringify(o);oe(Ot,`RPC '${e}' ${u} sending request:`,o),g.send(t,"POST",v,s,15)}))}Bo(e,t,s){const o=zh(),u=[this.Do,"/","google.firestore.v1.Firestore","/",e,"/channel"],h=ay(),m=oy(),g={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},v=this.longPollingOptions.timeoutSeconds;v!==void 0&&(g.longPollingTimeout=Math.round(1e3*v)),this.useFetchStreams&&(g.useFetchStreams=!0),this.Oo(g.initMessageHeaders,t,s),g.encodeInitMessageHeaders=!0;const T=u.join("");oe(Ot,`Creating RPC '${e}' stream ${o}: ${T}`,g);const N=h.createWebChannel(T,g);let b=!1,j=!1;const Q=new $T({Io:q=>{j?oe(Ot,`Not sending because RPC '${e}' stream ${o} is closed:`,q):(b||(oe(Ot,`Opening RPC '${e}' stream ${o} transport.`),N.open(),b=!0),oe(Ot,`RPC '${e}' stream ${o} sending:`,q),N.send(q))},To:()=>N.close()}),Y=(q,Ee,ge)=>{q.listen(Ee,(ye=>{try{ge(ye)}catch(we){setTimeout((()=>{throw we}),0)}}))};return Y(N,ga.EventType.OPEN,(()=>{j||(oe(Ot,`RPC '${e}' stream ${o} transport opened.`),Q.yo())})),Y(N,ga.EventType.CLOSE,(()=>{j||(j=!0,oe(Ot,`RPC '${e}' stream ${o} transport closed`),Q.So())})),Y(N,ga.EventType.ERROR,(q=>{j||(j=!0,to(Ot,`RPC '${e}' stream ${o} transport errored:`,q),Q.So(new ie(B.UNAVAILABLE,"The operation could not be completed")))})),Y(N,ga.EventType.MESSAGE,(q=>{var Ee;if(!j){const ge=q.data[0];Fe(!!ge);const ye=ge,we=ye.error||((Ee=ye[0])===null||Ee===void 0?void 0:Ee.error);if(we){oe(Ot,`RPC '${e}' stream ${o} received error:`,we);const ze=we.status;let Te=(function(S){const P=ot[S];if(P!==void 0)return Oy(P)})(ze),k=we.message;Te===void 0&&(Te=B.INTERNAL,k="Unknown error status: "+ze+" with message "+we.message),j=!0,Q.So(new ie(Te,k)),N.close()}else oe(Ot,`RPC '${e}' stream ${o} received:`,ge),Q.bo(ge)}})),Y(m,sy.STAT_EVENT,(q=>{q.stat===Xh.PROXY?oe(Ot,`RPC '${e}' stream ${o} detected buffering proxy`):q.stat===Xh.NOPROXY&&oe(Ot,`RPC '${e}' stream ${o} detected no buffering proxy`)})),setTimeout((()=>{Q.wo()}),0),Q}}function Bh(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class KT extends class{}{constructor(e,t,s,o){super(),this.authCredentials=e,this.appCheckCredentials=t,this.connection=s,this.serializer=o,this.y_=!1}w_(){if(this.y_)throw new ie(B.FAILED_PRECONDITION,"The client has already been terminated.")}Mo(e,t,s,o){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([u,h])=>this.connection.Mo(e,sd(t,s),o,u,h))).catch((u=>{throw u.name==="FirebaseError"?(u.code===B.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),u):new ie(B.UNKNOWN,u.toString())}))}Lo(e,t,s,o,u){return this.w_(),Promise.all([this.authCredentials.getToken(),this.appCheckCredentials.getToken()]).then((([h,m])=>this.connection.Lo(e,sd(t,s),o,h,m,u))).catch((h=>{throw h.name==="FirebaseError"?(h.code===B.UNAUTHENTICATED&&(this.authCredentials.invalidateToken(),this.appCheckCredentials.invalidateToken()),h):new ie(B.UNKNOWN,h.toString())}))}terminate(){this.y_=!0,this.connection.terminate()}}class GT{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,this.state="Unknown",this.S_=0,this.b_=null,this.D_=!0}v_(){this.S_===0&&(this.C_("Unknown"),this.b_=this.asyncQueue.enqueueAfterDelay("online_state_timeout",1e4,(()=>(this.b_=null,this.F_("Backend didn't respond within 10 seconds."),this.C_("Offline"),Promise.resolve()))))}M_(e){this.state==="Online"?this.C_("Unknown"):(this.S_++,this.S_>=1&&(this.x_(),this.F_(`Connection failed 1 times. Most recent error: ${e.toString()}`),this.C_("Offline")))}set(e){this.x_(),this.S_=0,e==="Online"&&(this.D_=!1),this.C_(e)}C_(e){e!==this.state&&(this.state=e,this.onlineStateHandler(e))}F_(e){const t=`Could not reach Cloud Firestore backend. ${e}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class DI{constructor(e){this.observer=e,this.muted=!1}next(e){this.muted||this.observer.next&&this.Ya(this.observer.next,e)}error(e){this.muted||(this.observer.error?this.Ya(this.observer.error,e):Ir("Uncaught Error in snapshot listener:",e.toString()))}Za(){this.muted=!0}Ya(e,t){setTimeout((()=>{this.muted||e(t)}),0)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ao{constructor(e){this._byteString=e}static fromBase64String(e){try{return new ao(Pt.fromBase64String(e))}catch(t){throw new ie(B.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(e){return new ao(Pt.fromUint8Array(e))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(e){return this._byteString.isEqual(e._byteString)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $d{constructor(...e){for(let t=0;t<e.length;++t)if(e[t].length===0)throw new ie(B.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new At(e)}isEqual(e){return this._internalPath.isEqual(e._internalPath)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wd{constructor(e,t){if(!isFinite(e)||e<-90||e>90)throw new ie(B.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+e);if(!isFinite(t)||t<-180||t>180)throw new ie(B.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+t);this._lat=e,this._long=t}get latitude(){return this._lat}get longitude(){return this._long}isEqual(e){return this._lat===e._lat&&this._long===e._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(e){return Oe(this._lat,e._lat)||Oe(this._long,e._long)}}/**
 * @license
 * Copyright 2024 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xa(i,e,t=!1){if(t)return e;try{return await e}catch(s){throw s instanceof Rr&&ES(s)&&i.auth.currentUser===i&&await i.auth.signOut(),s}}function ES({code:i}){return i==="auth/user-disabled"||i==="auth/user-token-expired"}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kg(i){const e=i.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(x_(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(k_(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(O_(e))return"Blackberry";if(L_(e))return"Webos";if(N_(e))return"Safari";if((e.includes("chrome/")||D_(e))&&!e.includes("edge/"))return"Chrome";if(V_(e))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,s=i.match(t);if((s==null?void 0:s.length)===2)return s[1]}return"Other"}function k_(i=bt()){return/firefox\//i.test(i)}function N_(i=bt()){const e=i.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function D_(i=bt()){return/crios\//i.test(i)}function x_(i=bt()){return/iemobile/i.test(i)}function V_(i=bt()){return/android/i.test(i)}function O_(i=bt()){return/blackberry/i.test(i)}function L_(i=bt()){return/webos/i.test(i)}function rf(i=bt()){return/iphone|ipad|ipod/i.test(i)||/macintosh/i.test(i)&&/mobile/i.test(i)}function RS(i=bt()){var e;return rf(i)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function PS(){return NE()&&document.documentMode===10}function M_(i=bt()){return rf(i)||V_(i)||L_(i)||O_(i)||/windows phone/i.test(i)||x_(i)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function eA(i,e,t=!1){const{auth:s}=i;if(Kn(s.app))return Promise.reject(wr(s));const o="reauthenticate";try{const u=await xa(i,z_(s,o,e,i),t);fe(u.idToken,s,"internal-error");const h=nf(u.idToken);fe(h,s,"internal-error");const{sub:m}=h;return fe(i.uid===m,s,"user-mismatch"),Yi._forOperation(i,o,u)}catch(u){throw(u==null?void 0:u.code)==="auth/user-not-found"&&Ln(s,"user-mismatch"),u}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const PA="pendingRedirect",Iu=new Map;class CA extends J_{constructor(e,t,s=!1){super(e,["signInViaRedirect","linkViaRedirect","reauthViaRedirect","unknown"],t,void 0,s),this.eventId=null}async execute(){let e=Iu.get(this.auth._key());if(!e){try{const s=await kA(this.resolver,this.auth)?await super.execute():null;e=()=>Promise.resolve(s)}catch(t){e=()=>Promise.reject(t)}Iu.set(this.auth._key(),e)}return this.bypassAuthState||Iu.set(this.auth._key(),()=>Promise.resolve(null)),e()}async onAuthEvent(e){if(e.type==="signInViaRedirect")return super.onAuthEvent(e);if(e.type==="unknown"){this.resolve(null);return}if(e.eventId){const t=await this.auth._redirectUserForId(e.eventId);if(t)return this.user=t,super.onAuthEvent(e);this.resolve(null)}}async onExecution(){}cleanUp(){}}async function kA(i,e){const t=xA(e),s=DA(i);if(!await s._isAvailable())return!1;const o=await s._get(t)==="true";return await s._remove(t),o}function NA(i,e){Iu.set(i._key(),e)}function DA(i){return vr(i._redirectPersistence)}function xA(i){return Tu(PA,i.config.apiKey,i.name)}async function VA(i,e,t=!1){if(Kn(i.app))return Promise.reject(wr(i));const s=Zi(i),o=TA(s,e),h=await new CA(s,o,t).execute();return h&&!t&&(delete h.user._redirectEventId,await s._persistUserIfCurrent(h.user),await s._setRedirectUser(null,e)),h}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function dR(i){switch(i){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function fR(i){eo(new Wi("auth",(e,{options:t})=>{const s=e.getProvider("app").getImmediate(),o=e.getProvider("heartbeat"),u=e.getProvider("app-check-internal"),{apiKey:h,authDomain:m}=s.options;fe(h&&!h.includes(":"),"invalid-api-key",{appName:s.name});const g={apiKey:h,authDomain:m,clientPlatform:i,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:b_(i)},v=new xS(s,o,u,g);return zS(v,t),v},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,s)=>{e.getProvider("auth-internal").initialize()})),eo(new Wi("auth-internal",e=>{const t=Zi(e.getProvider("auth").getImmediate());return(s=>new hR(s))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),oi(jg,zg,dR(i)),oi(jg,zg,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pR=300,mR=Qg("authIdTokenMaxAge")||pR;let Bg=null;const gR=i=>async e=>{const t=e&&await e.getIdTokenResult(),s=t&&(new Date().getTime()-Date.parse(t.issuedAtTime))/1e3;if(s&&s>mR)return;const o=t==null?void 0:t.token;Bg!==o&&(Bg=o,await fetch(i,{method:o?"POST":"DELETE",headers:o?{Authorization:`Bearer ${o}`}:{}}))};function yR(i=Zg()){const e=vd(i,"auth");if(e.isInitialized())return e.getImmediate();const t=jS(i,{popupRedirectResolver:cR,persistence:[wA,uA,K_]}),s=Qg("authTokenSyncURL");if(s&&typeof isSecureContext=="boolean"&&isSecureContext){const u=new URL(s,location.origin);if(location.origin===u.origin){const h=gR(u.toString());sA(t,h,()=>h(t.currentUser)),iA(t,m=>h(m))}}const o=Kg("auth");return o&&BS(t,`http://${o}`),t}function _R(){var i,e;return(e=(i=document.getElementsByTagName("head"))===null||i===void 0?void 0:i[0])!==null&&e!==void 0?e:document}VS({loadJS(i){return new Promise((e,t)=>{const s=document.createElement("script");s.setAttribute("src",i),s.onload=e,s.onerror=o=>{const u=Yn("internal-error");u.customData=o,t(u)},s.type="text/javascript",s.charset="UTF-8",_R().appendChild(s)})},gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="});fR("Browser");const vR={apiKey:"YOUR_API_KEY",authDomain:"YOUR_AUTH_DOMAIN",projectId:"YOUR_PROJECT_ID",storageBucket:"YOUR_STORAGE_BUCKET",messagingSenderId:"YOUR_MESSAGING_SENDER_ID",appId:"YOUR_APP_ID"},ev=Jg(vR),fa=jI(ev),mu=yR(ev);function ER(){const[i,e]=mn.useState("LOGIN"),[t,s]=mn.useState(null),[o,u]=mn.useState(null),[h,m]=mn.useState([]),[g,v]=mn.useState(!0),[T,N]=mn.useState(""),[b,j]=mn.useState(""),[Q,Y]=mn.useState(""),[q,Ee]=mn.useState("");mn.useEffect(()=>{const w=oA(mu,S=>{u(S),S?(ge(S.uid),e("MAIN")):e("LOGIN"),v(!1)});return()=>w()},[]);const ge=async w=>{const S=_g(da(fa,"users"),vg("uid","==",w));(await Tg(S)).forEach(D=>{s(D.data().role),Y(D.data().name)})},ye=async()=>{let w;t==="teacher"?w=da(fa,"records"):w=_g(da(fa,"records"),vg("studentId","==",o==null?void 0:o.uid));const P=(await Tg(w)).docs.map(D=>({id:D.id,...D.data()}));m(P)};mn.useEffect(()=>{(i==="TEACHER"||i==="MAIN")&&ye()},[i,t]);const we=async()=>{try{await rA(mu,T,b)}catch(w){alert("로그인 실패: "+w.message)}},ze=async()=>{try{const S=(await nA(mu,T,b)).user;await Ig(da(fa,"users"),{uid:S.uid,name:Q,role:t,email:T}),alert("회원가입 완료!"),e("MAIN")}catch(w){alert("회원가입 실패: "+w.message)}},Te=async(w,S)=>{try{await Ig(da(fa,"records"),{studentId:o.uid,name:Q,activity:w,feedback:S,status:"완료",date:new Date().toISOString().split("T")[0],timestamp:oS()}),alert("제출되었습니다!"),e("MAIN")}catch(P){alert("제출 실패: "+P.message)}},k=()=>Z.jsxs("div",{className:"bg-blue-600 text-white p-4 text-center font-bold",children:[Z.jsxs("div",{className:"flex justify-between items-center max-w-xs mx-auto mb-1",children:[Z.jsx("p",{className:"text-xs opacity-80",children:"라이프 스킬을 통한"}),o&&Z.jsx("button",{onClick:()=>mu.signOut(),className:"text-xs bg-blue-700 px-2 py-1 rounded",children:"로그아웃"})]}),Z.jsx("h1",{className:"text-xl",children:"피지컬 리터러시 기르기"})]});if(g)return Z.jsx("div",{className:"flex items-center justify-center h-screen",children:"로딩 중..."});if(i==="LOGIN")return Z.jsxs("div",{className:"max-w-md mx-auto border h-[700px] flex flex-col bg-white",children:[Z.jsx(k,{}),Z.jsxs("div",{className:"flex-1 flex flex-col justify-center p-8 gap-4",children:[Z.jsx("input",{className:"border-b p-2 focus:outline-none",placeholder:"이메일 (아이디)",value:T,onChange:w=>N(w.target.value)}),Z.jsx("input",{className:"border-b p-2 focus:outline-none",type:"password",placeholder:"비밀번호",value:b,onChange:w=>j(w.target.value)}),Z.jsx("button",{onClick:we,className:"bg-blue-500 text-white p-3 rounded font-bold",children:"로그인"}),Z.jsx("button",{onClick:()=>e("TYPE"),className:"text-gray-500 text-sm",children:"회원가입"})]})]});if(i==="SIGNUP")return Z.jsxs("div",{className:"max-w-md mx-auto border h-[700px] bg-white p-6 overflow-y-auto",children:[Z.jsxs("h2",{className:"text-xl font-bold mb-6",children:["정보 입력 (",t==="student"?"학생":"선생님",")"]}),Z.jsxs("div",{className:"flex flex-col gap-4 text-sm",children:[Z.jsxs("div",{children:[Z.jsx("p",{className:"mb-1 font-bold",children:"이름"}),Z.jsx("input",{className:"w-full border p-2 rounded",placeholder:"이름 입력",value:Q,onChange:w=>Y(w.target.value)})]}),Z.jsxs("div",{children:[Z.jsx("p",{className:"mb-1 font-bold",children:"이메일"}),Z.jsx("input",{className:"w-full border p-2 rounded",placeholder:"이메일 입력",value:T,onChange:w=>N(w.target.value)})]}),Z.jsxs("div",{children:[Z.jsx("p",{className:"mb-1 font-bold",children:"비밀번호"}),Z.jsx("input",{className:"w-full border p-2 rounded",type:"password",placeholder:"8~20자 영문+숫자 조합",value:b,onChange:w=>j(w.target.value)})]})]}),Z.jsx("button",{onClick:ze,className:"w-full bg-green-500 text-white p-4 rounded-lg font-bold mt-8",children:"가입 완료"})]});if(i==="MAIN")return Z.jsxs("div",{className:"max-w-md mx-auto border h-[700px] bg-white flex flex-col",children:[Z.jsx(k,{}),Z.jsxs("div",{className:"p-8 flex-1",children:[Z.jsxs("p",{className:"text-xl mb-8",children:[Z.jsx("b",{children:Q||"사용자"})," 님 반갑습니다."]}),Z.jsxs("div",{className:"grid gap-4",children:[Z.jsx("button",{onClick:()=>e("ACTIVITY_LIST"),className:"p-6 border-2 border-blue-500 rounded-xl text-left flex justify-between items-center group hover:bg-blue-50",children:Z.jsxs("div",{children:[Z.jsx("p",{className:"font-bold text-lg text-blue-600",children:"운동 시작 →"}),Z.jsx("p",{className:"text-sm text-gray-500",children:"학년별 맞춤 활동을 확인하세요"})]})}),Z.jsx("button",{className:"p-6 border rounded-xl text-left flex justify-between items-center hover:bg-gray-50",children:Z.jsxs("div",{children:[Z.jsx("p",{className:"font-bold text-lg",children:"마이 페이지 →"}),Z.jsx("p",{className:"text-sm text-gray-500",children:"나의 운동 기록과 통계"})]})}),t==="teacher"&&Z.jsx("button",{onClick:()=>e("TEACHER"),className:"p-4 bg-gray-800 text-white rounded-xl mt-4",children:"학급 활동 관리 (교사용)"})]})]})]});if(i==="ACTIVITY_DETAIL")return Z.jsxs("div",{className:"max-w-md mx-auto border h-[700px] bg-white flex flex-col",children:[Z.jsxs("div",{className:"p-4 border-b font-bold flex justify-between",children:[Z.jsx("span",{children:"양말 공 골인"}),Z.jsx("button",{onClick:()=>e("ACTIVITY_LIST"),children:"X"})]}),Z.jsxs("div",{className:"p-6 flex-1 overflow-y-auto",children:[Z.jsxs("div",{className:"bg-blue-50 p-4 rounded-lg mb-6 text-sm",children:[Z.jsx("p",{className:"font-bold text-blue-800 mb-1",children:"대상: 6학년 | 단원: 2. 스포츠"}),Z.jsx("p",{className:"text-gray-600",children:"돌돌 만 양말을 거실 한쪽에 둔 바구니 안으로 발 안쪽을 이용해 정확히 밀어넣는 연습"})]}),Z.jsxs("div",{className:"mb-6",children:[Z.jsx("p",{className:"font-bold mb-2 text-sm",children:"참여 인증 파일"}),Z.jsx("div",{className:"border-2 border-dashed p-8 text-center text-gray-400 rounded-lg cursor-pointer hover:bg-gray-50",children:"파일 선택 (사진/영상)"})]}),Z.jsxs("div",{children:[Z.jsx("p",{className:"font-bold mb-2 text-sm",children:"참여 후기"}),Z.jsx("textarea",{className:"w-full border p-3 h-32 rounded text-sm",placeholder:"후기를 작성해 주세요...",value:q,onChange:w=>Ee(w.target.value)})]}),Z.jsx("button",{onClick:()=>Te("양말 공 골인",q),className:"w-full bg-blue-600 text-white p-4 rounded-lg font-bold mt-6 shadow-md",children:"인증 완료"})]})]});if(i==="TEACHER")return Z.jsxs("div",{className:"max-w-md mx-auto border h-[700px] bg-gray-50 flex flex-col",children:[Z.jsxs("div",{className:"p-4 bg-gray-800 text-white flex justify-between items-center font-bold",children:[Z.jsx("span",{children:"학급 활동 리포트"}),Z.jsx("button",{onClick:()=>e("MAIN"),children:"홈으로"})]}),Z.jsxs("div",{className:"p-4 flex-1 overflow-y-auto",children:[Z.jsxs("div",{className:"bg-white rounded-lg shadow-sm mb-4",children:[Z.jsxs("div",{className:"p-3 border-b bg-gray-100 flex justify-between text-xs font-bold text-gray-500",children:[Z.jsx("span",{children:"학생명"}),Z.jsx("span",{children:"활동내용"}),Z.jsx("span",{children:"상태"})]}),h.map(w=>Z.jsxs("div",{className:"p-3 border-b flex justify-between items-center text-sm",children:[Z.jsx("span",{className:"font-medium",children:w.name}),Z.jsx("span",{className:"text-gray-600",children:w.activity}),Z.jsx("span",{className:"bg-green-100 text-green-700 px-2 py-1 rounded-full text-xs",children:"확인완료"})]},w.id))]}),Z.jsx("div",{className:"text-center p-4",children:Z.jsx("button",{className:"text-blue-500 text-sm font-bold underline",children:"기록 엑셀 다운로드"})})]})]})}pE.createRoot(document.getElementById("root")).render(Z.jsx(aE.StrictMode,{children:Z.jsx(ER,{})}));
